...
with open("./combine/K_COVID19.csv", 'r') as file:
    ...
    # Use column 18(case_id), 5(province), 6(city), 20(group), 7(infection_case), 21(confirmed), 25(latitude), 26(logitude)
    # index = column - 1
    col_list = { 
        'case_id' :17,
        'province' :4,
    ...
    for i,line in enumerate(file_read):
        ...
        try:
            ...
            print("[OK] Inserting [%s] to patientInfo"%(line[col_list['case_id']]))
